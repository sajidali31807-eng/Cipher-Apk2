...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final SherpaLibraryAccessors laccForSherpaLibraryAccessors = new SherpaLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>sherpa</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public SherpaLibraryAccessors getSherpa() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForSherpaLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class SherpaLibraryAccessors extends SubDependencyFactory {

        public SherpaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>onnx</b> with <b>com.k2fsa.sherpa.onnx:sherpa-onnx</b> coordinates and
         * with version reference <b>sherpaOnnx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getOnnx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("sherpa.onnx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistPermissions</b> with value <b>0.34.0</b>
         * <p>
        ...
        /**
         * Version alias <b>sherpaOnnx</b> with value <b>1.10.30</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSherpaOnnx() { return getVersion("sherpaOnnx"); }
